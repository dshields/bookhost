...
public abstract class _RootDAO extends amplitude.persistence.hibernate.base._BaseRootDAO {

    public _RootDAO() {
        setSessionFactory(null, HibernateSessionFactory.getSessionFactory());
        setSessionFactory("/hibernate.cfg.xml", HibernateSessionFactory.getSessionFactory());
    }
