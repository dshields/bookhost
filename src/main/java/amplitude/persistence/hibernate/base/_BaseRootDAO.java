...
public abstract class _BaseRootDAO {
    ...
    public static void initialize() {
        amplitude.persistence.hibernate.dao._RootDAO.initialize((String) null);
    }
    ...
    public static void initialize(String configFileName) {
        amplitude.persistence.hibernate.dao._RootDAO.initialize(configFileName, amplitude.persistence.hibernate.dao._RootDAO.getNewConfiguration(null));
    }
    ...
    public static void initialize(String configFileName, Configuration configuration) {
        if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName))
            ...
            if (null == configFileName) {
                ...
                amplitude.persistence.hibernate.dao._RootDAO.setSessionFactory(null, configuration.buildSessionFactory());
            } else {
                //configuration.configure(
                //configFileName);
                amplitude.persistence.hibernate.dao._RootDAO.setSessionFactory(configFileName, configuration.buildSessionFactory());
            }
        }
    }
    ...
    public static Configuration getNewConfiguration(String configFileName) {
        ...
        cfg.setProperty("hibernate.connection.url", AmplitudeProperties.getAmplitudeProperties().getDatabaseURL());
        return cfg;
    }
     ...
     * Close the session
     */
    public void closeSessionForReal(Session session) {
        if (null != session)
            session.close();
    }
